    ...
    <main className="py-10">
      <div className="container">
        <div className="mt-4 max-w-80 text-sm font-normal text-justify">
          ...
          <p className="mb-4">
            Hello, my name is Mico, and I created One-26. My inspiration is a
            popular video recording and sharing service. On their free tier,
            they only allow 25 five-minute videos, which total to 125 minutes of
            recording time. One-26 simply aims to allow users to record more
            than that.
          </p>
          <p className="mb-4">
            I am practicing my software development skills, too. That's why I
            created this. Hire me!
          </p>
          ...
          <p className="mb-4">
            By signing in, the user ("you") allow One-26 ("us", "we") to create
            a folder in your account's Google Drive. We will upload all your
            recordings on that folder.
          </p>
          <p className="mb-4">
            We do not store any of your information in our own servers and
            storages. We simply allow users to create recordings and upload them
            on their own Google Drive storage on-the-fly.
          </p>
          <p className="mb-4">
